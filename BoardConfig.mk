...
WIFI_DRIVER_FW_PATH_AP := "$(TARGET_COPY_OUT_VENDOR)/firmware/fw_bcmdhd_apsta.bin"
WIFI_DRIVER_FW_PATH_P2P := "$(TARGET_COPY_OUT_VENDOR)/firmware/fw_bcmdhd.bin"
WIFI_DRIVER_FW_PATH_PARAM := "/sys/module/bcmdhd/parameters/firmware_path"
WIFI_DRIVER_FW_PATH_STA := "$(TARGET_COPY_OUT_VENDOR)/firmware/fw_bcmdhd.bin"
